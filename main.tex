...
\section{似然比检验}\label{sec:7.6}
\subfile{Chapter_7/7.6.tex}
\section{两总体比较}\label{sec:7.7}
\subfile{Chapter_7/7.7.tex}
\section{Bayes 假设检验}\label{sec:7.8}
\subfile{Chapter_7/7.8.tex}

\chapter{线性回归}\label{chap:8}
\section{回归问题}\label{sec:8.1}
\subfile{Chapter_8/8.1.tex}
\section{简单线性回归}\label{sec:8.2}
\subfile{Chapter_8/8.2.tex}
\section{最小二乘法估计参数}\label{sec:8.3}
\subfile{Chapter_8/8.3.tex}
\section{回归参数推断}\label{sec:8.4}
\subfile{Chapter_8/8.4.tex}
\section{预测}\label{sec:8.5}
